...
public:
     ...
     */
    NavigationComplementaryFilter(Gyroscope_Interface* gyro = nullptr, Accelerometer_Interface* accel = nullptr, Magnetometer_Interface* mag = nullptr, Barometer_Interface* baro = nullptr, GNSS_Interface* gnss = nullptr) : Task_Abstract("Complementary Navigation", 8000, eTaskPriority_t::eTaskPriority_VeryHigh) {
        if (gyro != nullptr) {
