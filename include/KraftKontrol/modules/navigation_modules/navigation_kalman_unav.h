#ifndef NAVIGATION_KALMAN_UNAV_H
#define NAVIGATION_KALMAN_UNAV_H
...
#include "lib/uNavINS-master/uNavINS.h"



class NavigationKalmanUNAV: public Navigation_Abstract, public Task_Abstract {
private:
...
public:
    ...
    NavigationKalmanUNAV(SystemModel_Abstract& systemModel);
