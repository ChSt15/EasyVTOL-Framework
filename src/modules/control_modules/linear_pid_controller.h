...
public:
     ...
     * @return none.
     */
    void setAngularAccelerationPIDFactors(const Vector &factorP = 0, const Vector &factorI = 0, const Vector &factorD = 0, const Vector &limit = 0) {_angAccelPF = factorP; _angAccelIF = factorI; _angAccelDF = factorD; _angAccelLimit = limit;}
     ...
     * @return none.
     */
    void setAngularVelocityPIDFactors(const Vector &factorP = 0, const Vector &factorI = 0, const Vector &factorD = 0, const Vector &limit = 0) {_angVelPF = factorP; _angVelIF = factorI; _angVelDF = factorD; _angVelLimit = limit;}
     ...
     * @return none.
     */
    void setAttitudePIDFactors(const Vector &factorP = 0, const Vector &factorI = 0, const Vector &factorD = 0, const Vector &limit = 0) {_attitudePF = factorP; _attitudeIF = factorI; _attitudeDF = factorD; _attitudeLimit = limit;}
     ...
     * @return none.
     */
    void setAccelerationPIDFactors(const Vector &factorP = 0, const Vector &factorI = 0, const Vector &factorD = 0, const Vector &limit = 0) {_accelPF = factorP; _accelIF = factorI; _accelDF = factorD; _accelLimit = limit;}
     ...
     * @return none.
     */
    void setVelocityPIDFactors(const Vector &factorP = 0, const Vector &factorI = 0, const Vector &factorD = 0, const Vector &limit = 0) {_velocityPF = factorP; _velocityIF = factorI; _velocityDF = factorD; _velocityLimit = limit;}
     ...
     * @return none.
     */
    void setPositionPIDFactors(const Vector &factorP = 0, const Vector &factorI = 0, const Vector &factorD = 0, const Vector &limit = 0) {_positionPF = factorP; _positionIF = factorI; _positionDF = factorD; _positionLimit = limit;}
