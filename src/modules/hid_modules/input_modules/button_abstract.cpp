...
ButtonHID_Abstract::ButtonHID_Abstract(int64_t longPressThresholdTime, uint32_t buttonReadRate): Task_Abstract(buttonReadRate, eTaskPriority_t::eTaskPriority_Middle, true) {
